...
print("::DREFN::")
local RunBot = io.open("DREFN", 'w')
RunBot:write([[
#!/usr/bin/env bash
cd $HOME/DREFN
token="]]..database:get(Server_Done.."Token_Write")..[["
rm -fr DREFN.lua
wget "https://raw.githubusercontent.com/LARICATEAM/DREFN/master/DREFN.lua"
while(true) do
rm -fr ../.telegram-cli
./tg -s ./DREFN.lua -p PROFILE --bot=$token
done
]])
RunBot:close()
...
while(true) do
rm -fr ../.telegram-cli
screen -S DREFN -X kill
screen -S DREFN ./DREFN
done
]])
RunTs:close()
end
